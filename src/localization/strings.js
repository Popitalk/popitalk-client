...
let strings = new LocalizedStrings({
  ...
  en: {
    ...
    yourChannelsPlaceholder: "Create a channel",
  ...
  ko: {
    ...
    recentFriends: "최근 친구",
    yourChannels: "내 채널",
    yourChannelsPlaceholder: "뽀삐톡 채널 만들기",
    ...
    editChannelSubtitle:
      "채널 이름, 설명과 카테고리를 설정해서 나만의 채널을 관리하세요.",

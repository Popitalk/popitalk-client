...
function WelcomePage(props) {
  return (
    <div className="w-full h-full">
      <section className="flex sm:flex-row flex-col rounded-b-lg bg-primaryBackground justify-around items-center pl-20 pb-20 shadow-xl">
        <div className="bg-gradient-r-primary rounded-circle p-2 flex items-center lg:w-104 lg:h-104 md:w-84 md:h-84 sm:w-0 sm:h-0">

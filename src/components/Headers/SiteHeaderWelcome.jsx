...
const SiteHeaderWelcome = ({ apiLoading, apiError, dispatchLogin }) => {
  ...
  return (
    <header className="relative flex h-auto w-full md:px-16 px-4 py-2 justify-between bg-background-primary">
      ...
      <div
        ...
        } sm:flex flex-col bg-background-primary shadow-xl rounded-b-lg`}
      >

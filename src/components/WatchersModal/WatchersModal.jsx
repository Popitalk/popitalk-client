...
export default function WatchersModal() {
  ...
  return (
    <div className="WatchersModal--container">
      <div className="WatchersModal--header">
        <h3>Watching now</h3>
        <div className="WatchersModal--search">
          <div>
            <div>
      ...
      <div className="WatchersModal--users">
        {filteredUsers.length === 0 ? (
          <div className="WatchersModal--noneFound">

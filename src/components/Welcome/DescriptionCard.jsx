...
export default function DescriptionCard({ title, src, description }) {
  return (
    <div className="flex flex-col items-center w-full h-auto bg-secondaryBackground shadow-md hover:shadow-lg rounded-lg mx-4 p-4 lg:p-8">
